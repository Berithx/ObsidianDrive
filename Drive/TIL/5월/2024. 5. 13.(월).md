...
### - Apache Tomcat
- 동적인 처리를 할 수 있는 웹 서버를 만들기 위한 웹 컨테이너![[Pasted image 20240513212524.png]]
...
```
- 위에서 정리한 Build.gradle의 <font color="#00b0f0">dependencies</font> 부분에서 <font color="#00b050">spring-boot-starter-web</font> 처럼 필요한 
